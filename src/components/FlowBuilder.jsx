    ...
    <div className={`wf-workspace show-${panel}`}>
      ...
      <aside className="wf-inspector">
        {selected ? <>
          ...
          {!isAnnotation(selected) && <section className="wf-config-section"><h3>Anclajes</h3><p>Superior · Derecho · Inferior · Izquierdo</p><p>{edges.filter(e => e.source === selectedId || e.target === selectedId).length} de 4 conexiones. Cada lado puede ser origen o destino.</p></section>}
